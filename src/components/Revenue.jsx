...
const Revenue = () => {
  return (
    <div className="grid grid-cols-[50%_50%] my-5 gap-1 w-[97%] mx-auto">
      <div className="rounded-md shadow-lg overflow-hidden bg-white">
        ...
        <div className="mt-3 px-10">
          ...
          <img src={images.chart} className="pt-10" />
      ...
      <div className="mx-auto rounded-md shadow-lg overflow-hidden bg-white">
        ...
        <div className="mt-3 px-10 grid grid-cols-2">
          <div>
          ...
          <div className="flex flex-col gap-5 mt-10">
            <div className="flex flex-row space-x-4">
              ...
              <div className="flex flex-col pt-3">
                ...
                <span className="text-sm text-gray-400">Daily customers</span>
              </div>
            </div>
